...
#if GENERATE_ERRORS
		.(
		; Remind coder that we're injecting errors.
...
reminder
		...
		.byt	13
		.byt	"THE DRIVECODE WILL INJECT RANDOM",13
		.byt	"READ/TRANSFER ERRORS TO CAUSE DELAYS."
		.byt	13
		.byt	0
done
		.)
...
loadfile
		...
		; Make sure ATN is pulled and clock isn't, wait for EOF2.
		...
		; Acknowledge EOF2 while pulling clock/data for at least 19 cycles.
...
recvloop
		...
		inc	mod_recvdest+1		; one cycle too much here
		ldy	#8
